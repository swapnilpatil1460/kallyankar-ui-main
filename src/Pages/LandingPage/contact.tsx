...
const Contact = () => (
  <section id="contact" className="mx-auto max-w-7xl px-5 py-20 sm:px-8 lg:px-10 lg:py-28">
    <div className="overflow-hidden rounded-[2rem] bg-theme-c1 border border-theme-c3 shadow-xl lg:grid lg:grid-cols-[.9fr_1.1fr]">
      <div className="bg-black p-8 text-gray-200 sm:p-12">
      ...
      <div className="bg-theme-c2 p-8 sm:p-12 text-gray-200"><p className="text-sm font-bold uppercase tracking-[0.2em] text-gray-400">Quick support</p><h3 className="mt-4 text-3xl font-bold tracking-tight text-gray-200">Have a question? Start a conversation.</h3><p className="mt-4 max-w-md leading-7 text-gray-400">Send us a WhatsApp message for quick assistance with availability, replacement and battery guidance.</p><a href="https://wa.me/919359163465" target="_blank" rel="noreferrer" className="mt-8 inline-flex items-center gap-2 rounded-full bg-theme-c1 px-6 py-3.5 font-semibold text-gray-200 transition hover:bg-theme-c1-b"><MessageCircle size={19} /> Chat on WhatsApp</a></div>
    </div>
  </section>
);
