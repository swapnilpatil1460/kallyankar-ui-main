...
import { KB_1, KB_2, KB_3, KalyankarShop, LandingPageBattery, KB_Stack, KB_Certificate } from "../../assets/images";
      ...
      <section id="workplace" className="overflow-hidden bg-theme-c2 border-y border-theme-c3 px-5 py-20 text-gray-700 sm:px-8 lg:px-10 lg:py-28">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-12 w-full max-w-5xl mx-auto">
            <ImageSlider images={[KB_1, KB_2, KB_3, KalyankarShop, LandingPageBattery, KB_Stack, KB_Certificate]} interval={3000} />
          </div>
        </div>
      </section>
      <Contact />
