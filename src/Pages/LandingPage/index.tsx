...
const LandingPage = () => (
  <div className="bg-theme-bg text-gray-200">
    <LandingPageHeader />
    <main>
      <section id="services" className="mx-auto max-w-7xl px-5 py-20 sm:px-8 lg:px-10 lg:py-28">
        <div className="grid gap-12 lg:grid-cols-[.8fr_1.2fr] lg:items-end">
          <div>
            ...
            <div className="mt-8 inline-flex items-center gap-3 rounded-2xl bg-theme-c2 px-5 py-4 text-gray-200 border border-theme-c3">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {services.map((service) => <article key={service.title} className="group rounded-3xl border border-theme-c3 bg-theme-c2 p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:border-theme-c1 hover:shadow-xl">
              <div className="mb-5 inline-flex rounded-2xl bg-black p-3 text-gray-200 border border-theme-c3 transition group-hover:bg-theme-c1 group-hover:border-theme-c1">{service.icon}</div>
      ...
      <section id="workplace" className="overflow-hidden bg-theme-c2 border-y border-theme-c3 px-5 py-20 text-gray-200 sm:px-8 lg:px-10 lg:py-28">
